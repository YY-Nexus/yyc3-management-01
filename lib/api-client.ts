...
export function useApiClient() {
  ...
  async function fetchApi<T = any>(url: string, options: ApiClientOptions = {}): Promise<T> {
  ...
  return {
    get: <T = any>(url: string, headers?: Record<string, string>) => fetchApi<T>(url, { method: "GET", headers }),
    ...
    delete: <T = any>(url: string, body?: any, headers?: Record<string, string>) =>
