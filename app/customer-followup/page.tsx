...
export default function CustomerFollowup() {
  ...
  const addOrUpdateCustomer = () => {
    ...
    if (isEditing && editingId !== null) {
      setCustomers(
        customers.map((customer) => (customer.id === editingId ? { ...newCustomer, id: editingId } : customer)),
      )
      setIsEditing(false)
      setEditingId(null)
    } else {
    ...
    setNewCustomer({ name: "", phone: "", memberNo: "", date: "", notes: "", lastContact: "", nextContact: "" })
  }
    ...
    <div className="p-6 animate-fade-in">
      ...
      <div className="mb-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 animate-slide-in">
        ...
        <div>
          ...
          <Input id="memberNo" name="memberNo" value={newCustomer.memberNo} onChange={handleInputChange} required />
        </div>
        <div>
        ...
        <div className="col-span-full">
          ...
          <Textarea id="notes" name="notes" value={newCustomer.notes} onChange={handleInputChange} />
        </div>
        <div className="col-span-full">
