...
const AttendancePerformance = dynamic(() => import("@/components/attendance-performance"), { ssr: false })
const MultiDimensionalDashboard = dynamic(() => import("@/components/multi-dimensional-dashboard"), { ssr: false })
const OrganizationChart = dynamic(() => import("@/components/organization-chart"), { ssr: false })
const EmployeeHonorFund = dynamic(() => import("@/components/employee-honor-fund"), { ssr: false })
const GroupInteractions = dynamic(() => import("@/components/group-interactions"), { ssr: false })
const PaymentChannels = dynamic(() => import("@/components/payment-channels"), { ssr: false })
